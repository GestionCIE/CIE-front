    ...
    <Row className="Quienes">
      <div className="Quienes__container">
        <Row className="Quienes__container-desc">
          <Col xs={12} className="container__desc-text">
            <h1>¿Quienes somos?</h1>
            <p>
              ...
              iste eum vel! Dolor aspernatur veniam iusto!
            </p>
          </Col>
          <Col xs={12} className="container__desc-img">
            <img
              src="https://fakeimg.pl/700x700/282828/eae0d0/"
              alt="fake img"
            />
          </Col>
        </Row>
        ...
        <div className="Quienes__container-adviser">
          ...
          <Row className="adviser__container">
            <Col xs={12} className="adviser__container-badge">
              <Row>
                <Col xs={12} className="adviser__badge-img">
                  <img
                    src="https://fakeimg.pl/100x100/282828/eae0d0/"
                    alt="fake img"
                  />
                </Col>
                <Col xs={12} className="adviser__badge-text">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
