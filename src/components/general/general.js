                        ...
                        <p>Technical testing 3 2015-09-01</p>
                        {
                            this.state.lastActivitySystem.map(data =>{
                                ...
                                <Timeline.Item color="green">
                                    <p>{data.activity} ${data.date} - {data.hour}</p>
                                </Timeline.Item>
                                )
                            })
                        }
                        ...
                        </Col>
                        {
                            ...
                            this.state.eventStatistics.map( (data, index) =>{
                                return ( <Col span={24} key={index} >
                                            ...
                                            <Statistic title={data.eventName} value={data.numberRegistered} />
                                        </Card>
                                        <br/> 
                                    </Col>)                            
                                    }) 
                        ...
                        <Card className="General_Card_Meets">
                            <Row>
                                <Col span={24}>
                                    ...
                                    <span>Hora de inicio: 10:30 am</span> <span>Hora de Fin: 10:30 am</span>
                                    <br/>
                                </Col>
                                <Col span={24}>
                                    <div className="General_Card_Meets_Buttons">
                                    <Button className="Card_Meets_Button" type="default">Aceptar</Button>
