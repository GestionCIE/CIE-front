...
class AdvancedSettings extends React.Component {
    ...
    createSettingFacebook = async ()=> {
        ...
        if(response.result === 'created' || response.result === 'edited') 
            success({content: 'La configuracion de facebook se realizo correctamente'});
    ...
    createSettingEmail = async ()=> {
        ...
        if(response.result === 'created' || response.result === 'edited')
            success({content: 'La configuracion del servidor de correos se realizo correctamente'});
                    ...
                    <div className="Div_Setting">
                        <div className="Div_Setting_Header">
                            ...
                            <Space size={8}>
                                ...
                                <Switch checked={this.state.disableFc} 
                        ...
                        <Form className="Div_Setting_Fb_Form">
                            <Form.Item>
                                ...
                                <Input name="accessToken" value={this.state.accessToken} disabled={this.state.disableFc}
                                    placeholder="Token de acceso" onChange={this.onChange}/>
                            </Form.Item>

                            <Form.Item>
                                <label>ID de la pagina de facebook</label>
                                <Input name="idPage" value={this.state.idPage} disabled={this.state.disableFc}
                                    placeholder="ID de la pagina de facebook" onChange={this.onChange}/>
                            </Form.Item>

                            <Form.Item>
                                <label>Correo de la pagina</label>
                                <Input name="emailPage" value={this.state.emailPage} disabled={this.state.disableFc}
                                    placeholder="Coreo de la pagina" onChange={this.onChange}/>
                            </Form.Item>

                            <Form.Item>
                                <Button type="primary" className="Div_Setting_Button" 
                                onClick={this.createSettingFacebook}>Agregar Configuracion de facebook</Button>
                            </Form.Item>
                        </Form>
                    </div>
                ...
                <Col span={12}>
                    <div className="Div_Setting">
                        <div className="Div_Setting_Header">
                            ...
                            <Space size={8}>
                                <h6>Permitir Edicion</h6>
                                <Switch checked={this.state.disableEm}
                        ...
                        <Form>
                            <Form.Item>
                                ...
                                <Input name="emailNotification" value={this.state.emailNotification} 
                            ...
                            <Form.Item>
                                ...
                                <Input name="emailServer" placeholder="Servidor de correos" value={this.state.emailServer}
                                    disabled={this.state.disableEm}
                                    onChange={this.onChange}/>
                            </Form.Item>
                            <Form.Item>
                                <Button  type="primary" className="Div_Setting_Button" 
                                onClick={this.createSettingEmail}>Agregar Configuracion de servidor de correo</Button>
                            </Form.Item>
                        </Form>
                    </div>
                </Col>
