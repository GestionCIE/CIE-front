...
class AttendanceStatistics extends React.Component {
    ...
    async getStatistics(){
        const response = await http.get(`tracing/Statistics?type=${this.props.type}&id=${this.props.idEvent}`);
    ...
    render() {
        ...
        return(
            <Row>
                ...
                <Col span={12}>
                    <Statistic title={this.props.eventName} value={this.state.statistics} />
                </Col>
                <Col span={12}>
