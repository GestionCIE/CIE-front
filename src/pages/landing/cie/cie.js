      ...
      <Row>
        <Col span={24}>
          <div className="Text_Principal">
            <h1 className="Text_Principal_H1">
              Centro de Inovación y Emprendimiento
            </h1>
            <h3 className="Text_Principal_H3">
        ...
        <Col span={24}>
          <div className="Text_Tertiary">
            ...
            <p>
              Ayudamos a nuestros estudiantes a llevar a cabo sus
              emprendimientos
            </p>
            <p>
